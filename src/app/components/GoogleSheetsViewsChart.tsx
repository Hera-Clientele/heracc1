...
interface GoogleSheetsViewsChartProps {
  data: any[];
...
export default function GoogleSheetsViewsChart({ 
  data, 
  platform, 
  startDate, 
  endDate 
}: GoogleSheetsViewsChartProps) {
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-slate-400 text-sm">
            Views, Reach, and Profile Visits from Google Sheets
          </p>
        </div>
