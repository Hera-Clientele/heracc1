...
export async function GET(req: NextRequest) {
  try {
    ...
    const cacheKey = cacheKeys.dailyAgg(clientId, platform || 'meta-analytics');
    ...
    console.log('meta-analytics daily-agg API: Fetching fresh data');
    const data = await fetchMetaAnalyticsDailyAgg(clientId, platform);
