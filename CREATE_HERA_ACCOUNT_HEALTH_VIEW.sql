-- Create the hera_account_health view
-- This view provides account health metrics for social media accounts

CREATE OR REPLACE VIEW public.hera_account_health AS 
WITH view_trend AS (
  SELECT 
    d.account_id, 
    d.platform, 
